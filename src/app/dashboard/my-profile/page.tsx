...
//   return (
//     <div className="min-h-screen bg-[#F8F9FA] p-4 md:p-8 flex justify-center">
...
//               </div>
//             </div>
//             <Button className="bg-[#F37021] hover:bg-[#E0601B] text-white rounded-full px-8 py-5 font-medium shadow-none transition-colors w-full sm:w-auto">
//               Edit Profile
//             </Button>
//           </div>
...
//                 <Image
//                   src="/images/placeholder-workout.jpg"
...
//                   their physique.
//                 </p>
//                 <Button className="w-full sm:w-fit bg-[#F37021] hover:bg-[#E0601B] text-white rounded-full px-6 py-5 font-medium flex items-center justify-center gap-2 group transition-colors">
//                   Continue Your Class
...
//                   <CheckCircle2
//                     className="w-5 h-5 text-[#F37021] shrink-0"
//                     strokeWidth={2}
//                   />
//                 )}
//                 {item.state === 'current' && (
